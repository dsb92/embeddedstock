...
GO
PRINT N'Creating FK_Component_ToUserOwner...';


GO
ALTER TABLE [dbo].[Component] WITH NOCHECK
    ADD CONSTRAINT [FK_Component_ToUserOwner] FOREIGN KEY ([OwnerID]) REFERENCES [dbo].[User] ([StudentID]);


GO
PRINT N'Creating FK_Component_ToUserReservation...';


GO
ALTER TABLE [dbo].[Component] WITH NOCHECK
    ADD CONSTRAINT [FK_Component_ToUserReservation] FOREIGN KEY ([ReservationID]) REFERENCES [dbo].[User] ([StudentID]);
...
GO
ALTER TABLE [dbo].[Component] WITH CHECK CHECK CONSTRAINT [FK_Component_ToUserOwner];

ALTER TABLE [dbo].[Component] WITH CHECK CHECK CONSTRAINT [FK_Component_ToUserReservation];
